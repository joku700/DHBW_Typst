...
= Einleitung
@KI\-Agenten entwickeln sich seit 2022 von reinen Assistenten zu autonomen Akteuren, die komplexe Aufgaben eigenständig planen, ausführen und validieren können #cite(<sapkota_ai_2026>, supplement: "S. 7-8"). Sie generieren nicht nur Antworten auf Anfragen, sondern erstellen multimodale Inhalte wie Texte, Bilder und Analysen #cite(<sapkota_ai_2026>, supplement: "S. 7, 24") #cite(<liang_llm-powered_2025>, supplement: "S. 1"). Diese Entwicklung verspricht erhebliche Effizienzgewinne und neue Möglichkeiten in der Zusammenarbeit zwischen Mensch und Maschine #cite(<rai_editors_2019>, supplement: "S. iii") #cite(<sapkota_ai_2026>, supplement: "S. 39").

Doch mit wachsender Autonomie entstehen neue Herausforderungen. @KI\-generierte Inhalte werden von Problemen wie Halluzinationen, faktischen Ungenauigkeiten und inkonsistenten Aussagen beeinträchtigt. Studien zeigen, dass die Qualität KI-generierter Inhalte durch die iterative Einbindung menschlichen Feedbacks, durch das sogenannte @HITL\-Prinzip, erheblich verbessert werden kann #cite(<verhulsdonck_incorporating_2024>, supplement: "S. 60") #cite(<guo_using_2024>, supplement: "S. 1") #cite(<mosqueira-rey_human---loop_2023>, supplement: "S. 3006"). Durch gezieltes Feedback können Agenten ihren Kontext präzisieren, wodurch Faktoren wie Genauigkeit, Zuverlässigkeit und Transparenz optimiert werden können #cite(<verhulsdonck_incorporating_2024>, supplement: "S. 60") #cite(<guo_using_2024>, supplement: "S. 1") #cite(<rai_editors_2019>, supplement: "S. vi"). Zudem kann @HITL durch das _Interrupt and Resume_\-Integrationsmuster zur menschlichen Validierung an vordefinierten kritischen Stellen genutzt werden #cite(<durante_agent_2024>, supplement: "S. 36") #cite(<putta_agent_2024>, supplement: "S. 5").
...
In dieser Arbeit wird daher untersucht, wie ein @KI\-Agent eigenständig strukturierte Feedback-Formulare generieren kann, die auf den jeweiligen generierten Inhalt abgestimmt sind. Dabei steht die Frage im Zentrum, wie solche Formulare durch hohe @UX die Erfassung qualitativ hochwertigen Feedbacks unterstützen.
...
Kapitel 3 widmet sich der Konzeption. Zunächst wird die Ausgangssituation des SAP Lean Catalog Agenten beschrieben. Anschließend wird durch eine @NWA systematisch ermittelt, welcher Ansatz zur Generierung von Feedback-Formularen sich für den Anwendungsfall am besten eignet.
