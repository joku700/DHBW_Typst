...
== Grundlagen von KI
@KI beschreibt die Fähigkeit einer Maschine, kognitive Funktionen durchzuführen, die für gewöhnlich mit menschlichem Verstand assoziiert werden. Dies umfasst beispielsweise logisches Denken, Lernen, Entscheidungsfindung und Kreativität #cite(<rai_editors_2019>, supplement: "S. iii"). Frühe @KI\-Modelle basierten auf vordefinierten Regeln, wodurch sie wenig anpassungsfähig waren und nur spezifische Aufgaben lösen konnten #cite(<sapkota_ai_2026>, supplement: "S. 1").

@ML stellt eine der wichtigsten Entwicklung im Kontext von @KI dar. Hierbei leiten Modelle Muster aus Daten ab, um Vorhersagen bzw. Entscheidungen zu treffen, ohne dass diese Regeln programmatisch festgelegt werden müssen. Bei @ML wird zwischen den folgenden Lernparadigmen unterschieden #cite(<Kufel_2023>, supplement: "S. 4, 15").
- *Überwachtes Lernen*
Ein Modell lernt anhand von gekennzeichneten Daten, welche Eingaben zu welchen Ausgaben führen #cite(<Kufel_2023>, supplement: "S. 4")
- *Unüberwachtes Lernen*
Ein Modell erkennt Muster- bzw. Strukturen in ungekennzeichneten Daten #cite(<Kufel_2023>, supplement: "S. 4")
- *Bestärkendes Lernen*
Ein Modell lernt durch Interaktion mit einer Umgebung Strategien, um eine Belohnung zu maximieren #cite(<Kufel_2023>, supplement: "S. 15")
...
=== KI-Agenten
Agenten sind autonome Einheiten, die ihre Umgebung wahrnehmen und Handlungen ausführen können, um definierte Ziele zu erreichen #cite(<liang_llm-powered_2025>, supplement: "S. 1"). Durch den Einsatz von @KI erhalten Agenten zudem die oben genannten Fähigkeiten, die mit menschlichem Verstand in Verbindung gebracht werden #cite(<durante_agent_2024>, supplement: "S. 5").
Traditionelle Agenten basieren auf vordefinierten Regeln oder bestärkendem Lernen #cite(<VANMELLE1978313>) #cite(<Gronauer_Diepold_2022>). Dadurch sind sie nur in strukturierten Umgebungen effektiv und auf konkrete Aufgaben spezialisiert #cite(<liang_llm-powered_2025>, supplement: "S. 1").

Durch die ständige Entwicklung von @LLM:pl beweisen diese zunehmend logisches Denkvermögen und können Entscheidungen begründen bzw. verargumentieren #cite(<putta_agent_2024>, supplement: "S. 1"). Diese Fähigkeiten erlauben es @LLM:pl, über ihre typischen Einsatzfälle hinauszugehen und die Rolle von dynamischen Agenten einzunehmen #cite(<putta_agent_2024>, supplement: "S. 1"). @LLM\-basierte Agenten treffen Entscheidungen flexibel und adaptiv und können sich an neue unbekannte Aufgaben anpassen #cite(<liang_llm-powered_2025>, supplement: "S. 2-3"). Außerdem können sie mit unstrukturierten Daten wie menschlicher Sprache umgehen, wodurch unter Anderem die Mensch-@KI\-Kollaboration erheblich erhöht wird #cite(<liang_llm-powered_2025>, supplement: "S. 3").
...
Allerdings sind solche statischen Texte im Vergleich zu visuellen @UI:pl für menschliche Nutzer deutlich schwieriger zu erfassen und zu verarbeiten, insbesondere wenn die Textblöcke sehr lang sind #cite(<leviathan_generative_2025>). Hojo et al. bezeichnen dieses Problem als "Wall of Text" und zeigen, dass Nutzer komplexe Anforderungen selbst in Textprompts strukturieren müssen, was zu Fehlern führen kann #cite(<hojo_generativegui_2025>, supplement: "S. 1-2"). Zusätzlich bleiben kritische Aktionen wie Tool-Aufrufe und Ausführungsfortschritt oft hinter Chat-Nachrichten verborgen, was zu mangelnder Transparenz und vermindertem Nutzervertrauen führen kann #cite(<copilotkit_2026>).
...
Ein Katalog im Kontext des Lean Catalogs besteht aus verschiedenen Bereichen, die wiederum Unterbereiche haben können. Bereiche haben Titel und können von formatierten Detailtexten beschrieben werden. Außerdem können für Bereiche Bilder angelegt werden. Produkte sind einzelnen Bereichen zugeordnet und haben diverse beschreibende Texte und Bilder. In @img:example_catalog ist ein Screenshot des klassischen @UI:pl des @CatMan in SAP @GUI zu sehen. Dabei ist auf der linken Seite die Bereichsstruktur des Katalogs _Human In The Loop Test Catalog_ zu sehen. Auf der rechten Seite sind die Produkte des Bereichs _Kabel_ zu sehen, der wiederum in dem Bereich _Zubehör_ liegt.  
...
Für den Lean Catalog soll @KI zunächst für die Generierung von Bereichsbildern sowie bei der Übersetzung von Texten eingesetzt werden, da die manuelle Pflege dieser Inhalte einige Probleme mit sich bringt. Der Aufwand für die Auswahl passender Bereichsbilder, beispielsweise aus Stock-Footage-Bibliotheken, ist enorm, wobei die Qualität der Bilder teilweise schlecht und sehr inkonsistent ist. Eigene Aufnahmen würden zwar die Qualität der Bilder sicherstellen, wären aber noch deutlich aufwändiger. Der Aufwand für manuelle Übersetzungen wäre ebenfalls enorm. Zusätzlich müsste man sowohl innerhalb einer Sprache als auch sprachübergreifend konsistent gute Qualität gewährleisten, was ebenfalls sehr aufwändig, wenn nicht sogar unmöglich wäre. Außerdem würde man Experten mit Sprachkenntnissen für alle gewünschten Sprachen benötigen, was Personalkosten extrem erhöhen würde. 
...
Die Qualität @KI\-generierter Inhalte korreliert mit der Modellgröße nach mathematischen Skalierungsgesetzen #cite(<kaplan_scaling_2020>). Bei mathematischen Aufgaben wie dreistelliger Addition erreichen Modelle mit 6 Milliarden Parametern nur 1 % Genauigkeit, während 175-Milliarden-Parameter-Modelle auf 80 % springen #cite(<wei_emergent_2022>). Auch Halluzinationsraten variieren erheblich. Bei wissensintensiven Aufgaben enthielten 59,8 % der ChatGPT-Antworten mindestens eine faktische Halluzination #cite(<mishra_fine-grained_2024>).
...
Studien belegen zudem, dass menschliche Experten deutlich qualitativ hochwertigeres Feedback liefern als @KI\-Systeme alleine. Die Zustimmungsraten betragen 88 % bei menschlichem Feedback gegenüber nur 59 % bei @KI\-generiertem Feedback #cite(<guo_using_2024>). Dies unterstreicht die Notwendigkeit eines systematischen @HITL\-Ansatzes für den Lean Catalog, bei dem Administratoren generierte Inhalte prüfen, korrigieren und freigeben können, bevor diese für Endnutzer sichtbar werden.
...
Da @GenAI\-Systeme in der Regel nicht-deterministische Inhalte generieren, ist in diesem Kontext insbesondere Konsistenz und Standards (4) abzuwägen.
...
@UI\5 Fragments sind wiederverwendbare @UI\-Definitionen, die als XML-, HTML- oder JavaScript-Dateien vorliegen können. Sie ermöglichen die modulare Strukturierung von Benutzeroberflächen, indem komplexe @UI\-Elemente in separate, wiederverwendbare Komponenten ausgelagert werden.
...
Um mit komplexen Problemen, die oft unbekannte Variablen beinhalten, adäquat umgehen zu können, müssen oft Annahmen gemacht und anderweitig pauschalisiert werden #cite(<nwa>, supplement: "S. 7"). Auch intensive Recherchen können selten alle nötigen Informationen liefern #cite(<nwa>, supplement: "S. 7").
...
Experteninterviews sind eine qualitative Forschungsmethode, bei der nicht die Gesamtperson, sondern der Befragte als Repräsentant eines organisationalen oder fachlichen Kontextes im Vordergrund steht #cite(<Liebold_2009>, supplement: "S. 33"). Experten sind Personen, die über spezifisches Sonderwissen verfügen #cite(<Bogner_2002>). Im Gegensatz zu standardisierten Befragungen ermöglichen Experteninterviews die Erfassung von Erfahrungswissen, Prozesswissen und Deutungswissen #cite(<Liebold_2009>, supplement: "S. 35-36").
...
Die Auswertung von Experteninterviews erfolgt typischerweise thematisch-vergleichend #cite(<Liebold_2009>, supplement: "S. 51"). Den Textpassagen werden zunächst textnahe Überschriften (Codes) zugewiesen, die die Terminologie der Befragten aufgreifen. Anschließend werden ähnliche Themen aus verschiedenen Interviews zusammengestellt, um übergreifende Wissensbestände herauszuarbeiten #cite(<Liebold_2009>, supplement: "S. 53-54").
